...
const services: Service[] = [
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 24 24">
            <path fill="currentColor" d="M4 9h10.5v3.5H4zm0 5.5h10.5V18H4zM16.5 9H20v9h-3.5z" opacity={0.3}></path>
            <path fill="currentColor" d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m-5.5 14H4v-3.5h10.5zm0-5.5H4V9h10.5zM20 18h-3.5V9H20z"></path>
        </svg>,
        title: "Desenvolvimento de Sites",
        description: "Criação de sites profissionais, responsivos e otimizados para todos os dispositivos.",
        features: [
            "Responsivos",
    ...
    },
    {
        ...
        description: "Desenvolvimento de softwares para automatizar e otimizar processos do seu negócio.",
        features: [
    ...
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 24 24"><path fill="currentColor" d="m21 11.5l1.5 1.5l-6.99 7L11 15.5l1.5-1.5l3.01 3z"></path><path fill="currentColor" d="M17 5v3H7V5H5v14h6.68l-3.51-3.5l4.33-4.33l3.01 3l3.49-3.5V5z" opacity={0.3}></path><path fill="currentColor" d="M5 19V5h2v3h10V5h2v5.67l2-2V5c0-1.1-.9-2-2-2h-4.18C14.4 1.84 13.3 1 12 1s-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8.68l-2-2zm7-16c.55 0 1 .45 1 1s-.45 1-1 1s-1-.45-1-1s.45-1 1-1"></path></svg>,
        title: "Gestão de Estoque",
        description: "Sistemas completos para controle e gestão de estoque do seu negócio.",
        features: [
    ...
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 24 24"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}><rect width={10} height={14} x={3} y={8} rx={2}></rect><path d="M5 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2h-2.4M8 18h.01"></path></g></svg>,
    ...
    },
    {
        ...
        description: "Desenvolvimento e manutenção de bancos de dados para seu negócio.",
        features: [
            "Modelagem de dados",
