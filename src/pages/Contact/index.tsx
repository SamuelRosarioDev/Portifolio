...
export function Contact() {
    ...
    }; // Pegando os valores do contexto
        ...
        <Container>
            <Content>
                ...
                <ContactForm onSubmit={handleSubmit}>
                    ...
                    <BoxInput>
                        <Input type="text" name="name" placeholder={translation?.contact?.namePlaceholder} value={formData.name} onChange={handleChange} required />
